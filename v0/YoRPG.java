 ...
 *****************************************************/
  ...
  * Compile. Note messages generated.
      ERROR
      YoRPG.java:38: error: cannot find symbol
  private Protagonist pat;
          ^
  symbol:   class Protagonist
  location: class YoRPG
YoRPG.java:39: error: cannot find symbol
  private Monster smaug;
          ^
  symbol:   class Monster
  location: class YoRPG
YoRPG.java:96: error: cannot find symbol
    pat = new Protagonist( name );
              ^
  symbol:   class Protagonist
  location: class YoRPG
YoRPG.java:116: error: cannot find symbol
	    smaug = new Monster();
	                ^
  symbol:   class Monster
  location: class YoRPG
